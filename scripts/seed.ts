...
export const ACTIVITIES: Activity[] = [
  ...
  },
  {
    ...
    sort_order: 33,
    // ปิดชั่วคราวระหว่างขออนุมัติ AdSense
    // นโยบาย Google Publisher ห้ามโฆษณาบนเนื้อหาเชิงเพศ หน้านี้อ้างงานวิจัย
    // PLOS ONE จริงและเป็นเนื้อหาสุขภาพ แต่ระบบตรวจดูทั้งเว็บไม่ได้ดูรายหน้า
    // เปิดคืนได้ทันทีหลังอนุมัติผ่าน แค่เปลี่ยนกลับเป็น true แล้วรัน npm run seed
    is_active: false,
  },
